...
const Navbar = ({searchValue, setSearchValue}) => {
  ...
  const [navbarLink, setNavbarLink] = useState([
    ...
    { id: 6, text: "Architecture & Interiors", path: "architecture", search: "architecture" },
    { id: 7, text: "Textures & Patterns", path: "textures", search: "textures" },
    { id: 8, text: "Street Photography", path: "streetphotography", search: "streetphotography" },
    { id: 9, text: "Film", path: "film", search: "film" },
    { id: 10, text: "Archival", path: "archival", search: "archival" },
    { id: 11, text: "Experimental", path: "experimental", search: "experimental" },
    { id: 12, text: "Animals", path: "animals", search: "animals" },
    { id: 13, text: "Fashion & Beauty", path: "fashionbeauty", search: "fashionbeauty" },
    { id: 14, text: "People", path: "people", search: "people" },
    { id: 15, text: "Spirituality", path: "spirituality", search: "spirituality" },
    { id: 16, text: "Business & Work", path: "business-work", search: "business-work" },
    { id: 17, text: "Food & Drink", path: "food-drink", search: "food-drink" },
    { id: 18, text: "Health & Wellness", path: "health-wellness", search: "health-wellness" },
    { id: 19, text: "Sports", path: "sports", search: "sports" },
    { id: 20, text: "Current Events", path: "current-events", search: "current-events" },
  ]);
    ...
    <nav className="navbar fixed bg-white">
      <div className="navbar__top">
        ...
        <ul className="navbar__list">
          ...
          <li >
            <button className="navbar__btn hover:text-black border-[black]">Submit a photo</button>
          </li>
          ...
          {navbarLink?.map((item, index) => {
            return (
              <li  key={index} className="bottom__list-item relative">
                ...
                <Link to={item.path} className={`bottom__link hover:text-black pb-[10px] border-b-[3px] ${url === item.search ? "border-b-[3px] border-[black] pb-[10px] text-black" : "border-[transparent]"}`}>{item.text}</Link>
              </li>
            );
          })}
