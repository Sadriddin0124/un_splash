                ...
                <div className="picture__card-top">
                  <div className="card_item">
                    ...
                    <div className="flex gap-[10px]">
                      <button
                        className={`px-[15px] py-[10px] rounded-md cursor-pointer bg-white pictures__btn`}
                      >
                        <FaHeart />
                      </button>
                  ...
                  <div className="w-[100%] flex justify-between items-center ">
                    ...
                    <button
                      ...
                      className="bg-white rounded-md cursor-pointer pictures__btn download__btn"
                    >
                      <p>Download</p>
                      <FaArrowDown className="download__icon" />
                    </button>
                  </div>
                </div>
              </div>
